...
import com.sofkau.challenge.domain.catalogo.values.Capitulo;
...
public class Serie extends Entity<SerieId> {
    ...
    public void agregarCapituloATemporada(Temporada temporada, Capitulo capitulo ){
        Time duracion = capitulo.value().duracion();
        Informacion informacion = capitulo.value().informacion();
//        this.temporada.value().capitulo(informacion,duracion) = capitulo;
