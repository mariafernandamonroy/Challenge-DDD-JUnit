...
public class ActualizarInformacionPelicula extends Command {

    private final CatalogoId catalogoId;
    private final PeliculaId peliculaId;
    private final Informacion informacion;

    public ActualizarInformacionPelicula(CatalogoId catalogoId, PeliculaId peliculaId, Informacion informacion){
