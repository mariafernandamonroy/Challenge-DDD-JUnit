...
public class ActualizarInformacionSerie extends Command {
    ...
    public ActualizarInformacionSerie(CatalogoId catalogoId, SerieId serieId, Informacion informacion, Temporada temporada){
